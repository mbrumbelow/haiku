...
{
	// FIXME confirm which generation of CPU introduced the new layout with two registers.
	// In Linux driver it's BXT (Broxton) but that was cancelled and never sold. So my best
	// guess is "sometimes around 2015"
