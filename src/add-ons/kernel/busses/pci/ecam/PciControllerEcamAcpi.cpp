...
status_t
PciControllerEcamAcpi::ReadResourceInfo()
{
...
acpi_status
PciControllerEcamAcpi::AcpiCrsScanCallback(acpi_resource *res, void *context)
{
	return static_cast<PciControllerEcamAcpi*>(context)->AcpiCrsScanCallbackInt(res);
}


acpi_status
PciControllerEcamAcpi::AcpiCrsScanCallbackInt(acpi_resource *res)
{
	uint32 outType;
...
status_t
PciControllerEcamAcpi::Finalize()
{
