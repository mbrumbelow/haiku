...
public:
	virtual ~PciControllerEcam() = default;
...
class PciControllerEcamAcpi: public PciControllerEcam {
public:
	~PciControllerEcamAcpi() = default;
...
class PciControllerEcamFdt: public PciControllerEcam {
public:
	~PciControllerEcamFdt() = default;
