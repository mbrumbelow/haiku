...
/* Interrupt registers */
#define SDHCI_INT_CMD_CMP		0x00000001 		// command complete signal enable
#define SDHCI_INT_TRANS_CMP		0x00000002		// transfer complete signal enable
#define SDHCI_INT_CARD_INS 		0x00000040 		// card insertion signal enable
#define SDHCI_INT_CARD_REM 		0x00000080 		// card removal signal enable
