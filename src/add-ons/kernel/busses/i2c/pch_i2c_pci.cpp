...
#define PCH_I2C_PCI_DEVICE_MODULE_NAME "busses/i2c/pch_i2c_pci/driver_v1"
#define PCH_I2C_PCI_SIM_MODULE_NAME "busses/i2c/pch_i2c_pci/device/v1"

#define PCH_I2C_PCI_CONTROLLER_TYPE_NAME "pch i2c pci controller"
...
register_child_devices(void* cookie)
{
	...
	return gDeviceManager->register_node(node, PCH_I2C_PCI_SIM_MODULE_NAME,
		attrs, NULL, NULL);
}
...
static i2c_sim_interface sPchI2cPCIDeviceModule = {
	{
		{
			PCH_I2C_PCI_SIM_MODULE_NAME,
			0,
			NULL
		},
...
module_info* modules[] = {
	...
	(module_info* )&sPchI2cPCIDeviceModule,
	NULL
};
