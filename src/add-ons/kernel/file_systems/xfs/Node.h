...
#define XFS_NODE_CRC_OFF ((size_t)(&((NodeHeaderV5*)0)->info.crc))
#define XFS_NODE_V5_VPTR_OFF ((size_t)(&((NodeHeaderV5*)0)->info.forw))
#define XFS_NODE_V4_VPTR_OFF ((size_t)(&((NodeHeaderV5*)0)->info.forw))
