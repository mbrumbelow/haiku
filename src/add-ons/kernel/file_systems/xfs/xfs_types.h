...
typedef uint32					// block number for directories
	xfs_dablk_t;				// and extended attributes
typedef uint32					// hash of a directory file name 
	xfs_dahash_t;				// or extended attribute name
