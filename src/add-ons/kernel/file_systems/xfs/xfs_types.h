...
typedef uint32 xfs_dablk_t;    //block number for directories and extended attributes
typedef uint32 xfs_dahash_t;   //hash of a directory file name or extended attribute name
typedef uint64 xfs_fsblock_t;  //filesystem block number combining AG number and block offset into the AG
