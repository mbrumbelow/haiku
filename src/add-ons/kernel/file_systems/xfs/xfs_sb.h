...
/*
 ...
 If the lower nibble of sb_versionnum >=4 then the following features are checked.
 If it's equal to 5, it's version 5.
*/
...
#define XFS_SB_VERSION2_LAZYSBCOUNTBIT 0x0001 /* update global free space \
											  and inode on clean unmount*/
#define XFS_SB_VERSION2_ATTR2BIT 0x0002		  /* optimises the inode layout of ext-attr */
