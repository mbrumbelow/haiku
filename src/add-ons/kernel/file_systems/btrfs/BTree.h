...
//! Tree traversal direction status, used by TreeIterator functions
...
public:
			...
			/*! Traverse from the root to fill in th path along the way
			 * \return Current slot at leaf if successful, error code otherwise
			 */
...
public:
	...
	public:
		...
		//! Reset Node
		void	Keep();
		//! Reset Node and write cache to disk
		void	Unset();
...
public:
			...
			//! Set currnet key in the iterator
