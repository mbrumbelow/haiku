...
struct ufs2_inode {
	...
	union {
		struct {
			int64_t		directBlockPointer[12]; /* 12 direct block pointers */
			int64_t		indirectBlockPointer;  /* 1 Indirect block pointer */
			int64_t		doubleIndriectBlockPointer; // 1 Double Indirect block pointer
			int64_t		tripleIndriectBlockPointer; // 1 Triple Indirect block pointer
		};
