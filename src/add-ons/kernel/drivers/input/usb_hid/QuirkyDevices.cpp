...
static status_t decus_build_descriptor(HIDWriter &writer)
{
	uint8 rdesc[66] = {
...
0xC0, 0xC0
	...
	return writer.Write( &rdesc, sizeof( rdesc ));
}
...
usb_hid_quirky_device gQuirkyDevices[] = {
	...
	{
		0x1ea7, 0x1006, USB_INTERFACE_CLASS_HID, 0x01, 0x02, NULL, decus_build_descriptor
	}
};
