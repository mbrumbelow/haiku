...
#define DISPLAY_DEVICE_MODULE_NAME "drivers/display/display_adapter/display/device_v1"
...
#define DISPLAYADAPTER_PATHID_GENERATOR "display/display_adapter/path_id"
