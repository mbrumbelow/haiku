...
#define ACPI_VIDEOOUTPUT_DRIVER_NAME "drivers/display/acpi_video/output/driver_v1"
#define ACPI_VIDEOOUTPUT_DEVICE_NAME "drivers/display/acpi_video/output/device_v1"
