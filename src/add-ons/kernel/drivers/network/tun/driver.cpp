...
const char *device_names[] = {TUN_DRIVER_NAME, TAP_DRIVER_NAME, 
                                "misc/tun_interface", NULL};
...
tun_close(void* cookie)
{
    ...
    /* 
     * Currently KDL's on the line below but if `es` is used
