 ...
 *****************************************************************************/
uacpi_status
uacpi_kernel_po_write8(uacpi_handle, uacpi_size address, uint8 value)
{
#ifdef _KERNEL_MODE
...
uacpi_status
uacpi_kernel_io_write16(uacpi_handle, uacpi_size address, uint16 value)
{
#ifdef _KERNEL_MODE
	DEBUG_FUNCTION_F("addr: 0x%08lx; value: %" B_PRIu32,
		(addr_t)address, (uint32)value);
...
uacpi_status
uacpi_kernel_io_write32(uacpi_handle, uacpi_size address, uint32 value)
{
#ifdef _KERNEL_MODE
	DEBUG_FUNCTION_F("addr: 0x%08lx; value: %" B_PRIu32,
		(addr_t)address, (uint32)value);
