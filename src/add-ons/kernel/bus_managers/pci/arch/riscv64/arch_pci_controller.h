...
virtual	status_t				Init(device_node* pciRootNode);

virtual status_t				InitMSI(int32 irq);
virtual int32					AllocateMSIIrq();
virtual void					FreeMSIIrq(int32 irq);
virtual	void					InitDeviceMSI(uint8 bus, uint8 device, uint8 function);
virtual int32					HandleMSIIrq(void* arg);
