	...
	const BActivationTransaction& transaction)
{
	...
	// Clean up the empty transaction directory for first boot processing,
	// since it's usually an internal to package_daemon operation and there
	// is no external client to clean it up.
