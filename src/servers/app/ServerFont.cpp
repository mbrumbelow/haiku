...
ServerFont::BoundingBox()
{
	...
	if (IsScalable()) {
		...
		fBounds.top = 0;
		fBounds.left = 0;
		fBounds.right = width / 64.;
		fBounds.bottom = height / 64.;
	}
