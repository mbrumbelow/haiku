...
{
	const int32 allowed = (modifiers & kModifiers);
	const bool shiftDown = (allowed & B_SHIFT_KEY) != 0;
	const bool controlDown = (allowed & B_CONTROL_KEY) != 0;
	const bool optionDown = (allowed & B_OPTION_KEY) != 0;
