...
public:
    ...
    std::vector<${subtype_cppmodelclassname}*>* Target(); // list of %s pointers


private:
    std::vector<${subtype_cppmodelclassname}*>* fTarget;
};
...
${subtype_cppstackedlistlistenerclassname}::${subtype_cppstackedlistlistenerclassname}(
    ...
    ${cppsuperstackedlistenerclassname}(mainListener, parent)
{
    fTarget = new std::vector<${subtype_cppmodelclassname}*>();
}
...
std::vector<${subtype_cppmodelclassname}*>*
...
${subtype_cppstackedlistlistenerclassname}::Handle(const BJsonEvent& event)
{
    switch (event.EventType()) {
        ...
        case B_JSON_OBJECT_START:
        {
            ...
            fTarget->push_back(nextListener->Target());
            Push(nextListener);
            break;
        }
