...
Screenshot::_ShowHelp()
{
	...
	printf("  -c, --clipboard       Copies the screenshot to the system "
		...
		"window\n");
	printf("  -a, --select       Select an area of the screen to capture \n");
	printf("Note: Option -b, --border only takes effect when used with -w, "
		"--window;\nOption -a, --select does not take effect with -s, "
