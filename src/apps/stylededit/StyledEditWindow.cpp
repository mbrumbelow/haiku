...
StyledEditWindow::_InitWindow(uint32 encoding)
{
	...
	BMenuItem* fFontSizeUpItem = new BMenuItem(B_TRANSLATE("Increase size"),
		new BMessage(kMsgSetFontUp));
	BMenuItem* fFontSizeDownItem = new BMenuItem(B_TRANSLATE("Decrease size"),
		new BMessage(kMsgSetFontDown));
	fFontMenu->AddItem(fFontSizeUpItem);
	fFontMenu->AddItem(fFontSizeDownItem);
