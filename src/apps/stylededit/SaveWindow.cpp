...
SaveWindow::_InitInterface()
{
	...
	bar->SetRange(0.0f, fUnsavedFiles.CountStrings() > kMaxItems
		? (textHeight + 3.0f) * (unsavedFileCount - kMaxItems) : 0.0f);
...
// TODO: This SaveWindow should be reworked to utilize asynchronous messaging,
// instead of using a semaphore which blocks as long as the SaveWindow is open.
std::vector<bool>
SaveWindow::Go()
{
