...
SettingsWindow::_CreateGeneralPage(float spacing)
{
	...
	fSearchPageMenuCustom = new BMenuItem(B_TRANSLATE("Custom"),
	...
	message_google->AddString("searchstring",
	...
	message_bing->AddString("searchstring",
	...
	message_yahoo->AddString("searchstring",
	...
	message_duckduckgo->AddString("searchstring",
