...
SysInfoView::_DesktopTextColor() const
{
	...
	rgb_color viewColor = screen.DesktopColor();
...
SysInfoView::_BaseHeight()
{
	...
	return ceilf(((boldFH.ascent + boldFH.descent)
			* (fLabels.CountItems() + 1)
		+ (plainFH.ascent + plainFH.descent)
			* (fLabels.CountItems() + 2) // extra for fUptimeView
...
{
	return (int)sysInfo->ignored_pages * B_PAGE_SIZE / 1048576;
}
...
{
	return (int)sysInfo->max_pages * B_PAGE_SIZE / 1048576;
}
...
{
	return (int)(sysInfo->max_pages + sysInfo->ignored_pages) * B_PAGE_SIZE
		/ 1048576;
}
...
{
	return (int)sysInfo->used_pages * B_PAGE_SIZE / 1048576;
}
