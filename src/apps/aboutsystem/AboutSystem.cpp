	...
	fScrollRunner(NULL)
{
	...
	fTabView->AddTab(_CreateThirdPartyView(), thirdPartyTab);
	thirdPartyTab->SetLabel(B_TRANSLATE("Licenses"));
...
BView*
AboutView::_CreateThirdPartyView()
{
	// Begin construction of the credits view
	fLicensesView = new HyperTextView("copyrights view");
	...
	fLicensesView->Insert(B_TRANSLATE("Copyrights\n"));
