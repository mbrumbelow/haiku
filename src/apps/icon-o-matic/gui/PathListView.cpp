...
PathListView::_UpdateMenu()
{
	...
	fDuplicateItem->SetEnabled(gotSelection);
	fReverseItem->SetEnabled(gotSelection);
	fCleanUpItem->SetEnabled(gotSelection);
	fRotateIndicesLeftItem->SetEnabled(gotSelection);
	fRotateIndicesRightItem->SetEnabled(gotSelection);
