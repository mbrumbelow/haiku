...
FlatIconExporter::ErrorCodeToString(status_t code)
{
	switch (code) {
		case E_TOO_MANY_PATHS:
			return B_TRANSLATE("There at too many paths. "
				"The HVIF format supports a maximum of 255.");
		case E_PATH_TOO_MANY_POINTS:
			return B_TRANSLATE("One or more of the paths have too many points. "
				"The HVIF format supports a maximum of 255 points per path.");
