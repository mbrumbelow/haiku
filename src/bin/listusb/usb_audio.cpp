...
DumpAudioCSInterfaceDescriptorInputTerminal(
	const usb_audio_input_terminal_descriptor* descriptor, uint16 bcd_release_no)
{
	printf("                    Length............. %u\n", descriptor->length);
	printf("                    Type .............. 0x%02x\n",
		descriptor->descriptor_type);
...
DumpAudioCSInterfaceDescriptorOutputTerminal(
	const usb_audio_output_terminal_descriptor* descriptor, uint16 bcd_release_no)
{
	printf("                    Length............. %u\n", descriptor->length);
	printf("                    Type .............. 0x%02x\n",
		descriptor->descriptor_type);
...
DumpAudioCSInterfaceDescriptorFeatureUnit(
	const usb_audio_feature_unit_descriptor* descriptor, uint16 bcd_release_no)
{
	printf("                    Length............. %u\n", descriptor->length);
	printf("                    Type .............. 0x%02x\n",
		descriptor->descriptor_type);
