	...
	keyboardIcon(sBounds, B_CMAP8)
{
	...
	_LoadBitmap(&resources, mouse_icon, &mouseIcon);
	_LoadBitmap(&resources, touchpad_icon, &touchpadIcon);
	_LoadBitmap(&resources, keyboard_icon, &keyboardIcon);
}


void
InputIcons::_LoadBitmap(BResources* resources, int32 id, BBitmap* bitmap)
{
	const uint8* mouse;
