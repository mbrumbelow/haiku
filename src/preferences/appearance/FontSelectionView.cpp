	...
	fMessageTarget(this)
{
	...
	fPreviewText = BString("The quick brown fox jumps over the lazy dog.");

	// preview
	fPreviewTextView = new BStringView("preview text",
		B_TRANSLATE_COMMENT(fPreviewText,
