...
void
ModifierKeysWindow::_CreateMenuField(BPopUpMenu** outMenu, BMenuField** outField, unsigned inKey, const char* comment)
{
...
ModifierKeysWindow::_DuplicateKeys()
{
	...
	for (int32 testKey = MENU_ITEM_SHIFT; testKey < MENU_ITEM_SEPARATOR; testKey++) {
		uint32 testLeft = 0;
		uint32 testRight = 0;
