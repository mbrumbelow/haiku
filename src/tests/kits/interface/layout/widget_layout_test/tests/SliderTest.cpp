...
SliderTest::ActivateTest(View* controls)
{
	...
	fOrientationRadioGroup->SelectButton(0);
	...
	fThumbStyleRadioGroup->SelectButton(0);
	...
	fHashMarkLocationRadioGroup->SelectButton(0);
	...
	fLimitLabelsRadioGroup->SelectButton(0);
