...
BOutlineListView*
CreateAndFillView(BWindow* window)
{
...
{
	BApplication app("application/x-vnd.OutlineListView_EachItemUnder.test");
	BWindow* window = new BWindow(BRect(50, 50, 550, 550), "OutlineListView_EachItemUnder",
		B_TITLED_WINDOW, B_QUIT_ON_WINDOW_CLOSE, 0);
	BOutlineListView* view = CreateAndFillView(window);
...
{
	BApplication app("application/x-vnd.OutlineListView_AddUnder.test");
	BWindow* window = new BWindow(BRect(50, 50, 550, 550), "OutlineListView_AddUnder",
		B_TITLED_WINDOW, B_QUIT_ON_WINDOW_CLOSE, 0);
	BOutlineListView* view = CreateAndFillView(window);
...
{
	BApplication app("application/x-vnd.OutlineListView_ItemUnderAt.test");
	BWindow* window = new BWindow(BRect(50, 50, 550, 550), "OutlineListView_ItemUnderAt",
		B_TITLED_WINDOW, B_QUIT_ON_WINDOW_CLOSE, 0);
	BOutlineListView* view = CreateAndFillView(window);
