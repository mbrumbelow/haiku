...
DirectoryTest::InitTest1()
{
	...
	NextSubTest();
	{
		...
		CPPUNIT_ASSERT(dir.InitCheck() == B_NOT_A_DIRECTORY);
	}
	NextSubTest();
	{
...
DirectoryTest::InitTest2()
{
	...
	NextSubTest();
	// BeOS R5 returns B_BAD_VALUE instead of B_NOT_A_DIRECTORY.
	CPPUNIT_ASSERT(dir.SetTo(existingFile) == B_NOT_A_DIRECTORY);
	CPPUNIT_ASSERT(dir.InitCheck() == B_NOT_A_DIRECTORY);
	dir.Unset();
	//
	NextSubTest();
	...
	CPPUNIT_ASSERT( entry.InitCheck() == B_OK );
	// BeOS R5 returns B_BAD_VALUE instead of B_NOT_A_DIRECTORY.
	CPPUNIT_ASSERT(dir.SetTo(&entry) == B_NOT_A_DIRECTORY);
	CPPUNIT_ASSERT(dir.InitCheck() == B_NOT_A_DIRECTORY);
	dir.Unset();
	//
	NextSubTest();
	...
	CPPUNIT_ASSERT( entry.GetRef(&ref) == B_OK );
	// BeOS R5 returns B_BAD_VALUE instead of B_NOT_A_DIRECTORY.
	CPPUNIT_ASSERT(dir.SetTo(&ref) == B_NOT_A_DIRECTORY);
	CPPUNIT_ASSERT(dir.InitCheck() == B_NOT_A_DIRECTORY);
	dir.Unset();
	...
	CPPUNIT_ASSERT( node.GetNodeRef(&nref) == B_OK );
	// BeOS R5 returns B_BAD_VALUE instead of B_NOT_A_DIRECTORY.
	CPPUNIT_ASSERT(dir.SetTo(&nref) == B_NOT_A_DIRECTORY);
	CPPUNIT_ASSERT(dir.InitCheck() == B_NOT_A_DIRECTORY);
	dir.Unset();
	...
	CPPUNIT_ASSERT(dir.SetTo(&pathDir, "") == B_ENTRY_NOT_FOUND);
	CPPUNIT_ASSERT(dir.InitCheck() == B_ENTRY_NOT_FOUND);
	dir.Unset();
	//
	NextSubTest();
	...
	CPPUNIT_ASSERT( pathDir.InitCheck() == B_OK );
	// BeOS R5 returns B_BAD_VALUE instead of B_NOT_A_DIRECTORY.
	CPPUNIT_ASSERT(dir.SetTo(&pathDir, existingRelFile) == B_NOT_A_DIRECTORY);
	CPPUNIT_ASSERT(dir.InitCheck() == B_NOT_A_DIRECTORY);
	dir.Unset();
	//
	NextSubTest();
...
DirectoryTest::FindEntryTest()
{
	...
	CPPUNIT_ASSERT(normalizedExistingPath.InitCheck() == B_OK);

	BPath normalizedExistingSubPath(existingSub, NULL, true);
	CPPUNIT_ASSERT(normalizedExistingSubPath.InitCheck() == B_OK);

	BPath normalizedDirLinkPath(dirLink, NULL, true);
	CPPUNIT_ASSERT(normalizedDirLinkPath.InitCheck() == B_OK);

	BPath normalizedBadLinkPath(badLink, NULL, true);
	CPPUNIT_ASSERT(normalizedBadLinkPath.InitCheck() == B_OK);

	BPath normalizedCyclicLink1(cyclicLink1, NULL, true);
	CPPUNIT_ASSERT(normalizedCyclicLink1.InitCheck() == B_OK);
