...
{
	FakeJsonStreamDataIO* inputData = new FakeJsonStringStreamDataIO(kHighVolumeItemCount, kChecksumLimit);
	char c;
...
{
	FakeJsonStreamDataIO* inputData = new FakeJsonNumberStreamDataIO(kHighVolumeItemCount, kChecksumLimit);
	char c;
