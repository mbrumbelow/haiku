...
*/
void CryptoHashBlake2Tester::HashTest1()
{
...
Test*
CryptoHashBlake2Tester::Suite()
{
        TestSuite* SuiteOfTests = new TestSuite;

        ADD_TEST4(BCryptoHash, SuiteOfTests, CryptoHashBlake2Tester, HashTest1);
