...
public:
			...
			BMenuItem*			UpdateAddPrinterItem(BMenu*);
			BMenuItem*			UpdateCleanupItem(BMenu*);
			BMenuItem*			UpdateCloseAllInWorkspaceItem(BMenu*);
			BMenuItem*			UpdateCloseItem(BMenu*);
			BMenuItem*			UpdateCopyItem(BMenu*);
			BMenuItem*			UpdateCopyToItem(BMenu*);
			BMenuItem*			UpdateCreateLinkItem(BMenu*);
			BMenuItem*			UpdateCreateLinkHereItem(BMenu*);
			BMenuItem*			UpdateCutItem(BMenu*);
			BMenuItem*			UpdateDeleteItem(BMenu*);
			BMenuItem*			UpdateDuplicateItem(BMenu*);
			BMenuItem*			UpdateEditNameItem(BMenu*);
			BMenuItem*			UpdateEditQueryItem(BMenu*);
			BMenuItem*			UpdateEmptyTrashItem(BMenu*);
			BMenuItem*			UpdateFindItem(BMenu*);
			BMenuItem*			UpdateGetInfoItem(BMenu*);
			BMenuItem*			UpdateIdentifyItem(BMenu*);
			BMenuItem*			UpdateInvertSelectionItem(BMenu*);
			BMenuItem*			UpdateMakeActivePrinterItem(BMenu*);
			BMenuItem*			UpdateMoveToItem(BMenu*);
			BMenuItem*			UpdateMoveToTrashItem(BMenu*);
			BMenuItem*			UpdateNewFolderItem(BMenu*);
			BMenuItem*			UpdateNewTemplatesItem(BMenu*);
			BMenuItem*			UpdateOpenItem(BMenu*);
			BMenuItem*			UpdateOpenParentItem(BMenu*);
			BMenuItem*			UpdateOpenWithItem(BMenu*);
			BMenuItem*			UpdatePasteItem(BMenu*);
			BMenuItem*			UpdateResizeToFitItem(BMenu*);
			BMenuItem*			UpdateRestoreItem(BMenu*);
