...
{
	return fInWindow && fContainerWindow->TargetModel()->IsQuery();
}
...
{
	return fInWindow && fContainerWindow->TargetModel()->IsQueryTemplate();
}
...
{
	return fInWindow && fContainerWindow->TargetModel()->InTrash();
}
...
{
	return fInWindow && fContainerWindow->TargetModel()->IsTrash();
}
