...
//	#pragma mark - Shortcuts update item in menu methods


BMenuItem*
TShortcuts::UpdateAddPrinterItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;

	BMenuItem* item = menu->FindItem(kAddPrinter);
	if (item == NULL)
		return NULL;
...
BMenuItem*
TShortcuts::UpdateCleanupItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;

	BMenuItem* item = FindItem(menu, kCleanup, kCleanupAll);
	if (item == NULL)
		return NULL;
...
BMenuItem*
TShortcuts::UpdateCloseItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;

	BMenuItem* item = FindItem(menu, B_QUIT_REQUESTED, kCloseAllWindows);
...
BMenuItem*
TShortcuts::UpdateCloseAllInWorkspaceItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;

	BMenuItem* item = menu->FindItem(kCloseAllInWorkspace);
...
BMenuItem*
TShortcuts::UpdateCopyItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;

	BMenuItem* item = FindItem(menu, B_COPY, kCopyMoreSelectionToClipboard);
	UpdateCopyItem(item);
...
BMenuItem*
TShortcuts::UpdateCopyToItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;

	BMenuItem* item = menu->FindItem(kCopySelectionTo);
...
BMenuItem*
TShortcuts::UpdateCreateLinkItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;

	BMenuItem* item = FindItem(menu, kCreateLink, kCreateRelativeLink);
...
BMenuItem*
TShortcuts::UpdateCreateLinkHereItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;

	BMenuItem* item = menu->FindItem(kCreateLink);
	UpdateCreateLinkHereItem(item);
...
BMenuItem*
TShortcuts::UpdateCutItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;

	BMenuItem* item = FindItem(menu, B_CUT, kCutMoreSelectionToClipboard);
	UpdateCutItem(item);
...
BMenuItem*
TShortcuts::UpdateDeleteItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;

	BMenuItem* item = menu->FindItem(kDeleteSelection);
...
BMenuItem*
TShortcuts::UpdateDuplicateItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;

	BMenuItem* item = menu->FindItem(kDuplicateSelection);
...
BMenuItem*
TShortcuts::UpdateEditNameItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;

	BMenuItem* item = menu->FindItem(kEditName);
...
BMenuItem*
TShortcuts::UpdateEditQueryItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;
...
BMenuItem*
TShortcuts::UpdateEmptyTrashItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;

	BMenuItem* item = menu->FindItem(kEmptyTrash);
	if (item == NULL)
		return NULL;
...
BMenuItem*
TShortcuts::UpdateFindItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;

	BMenuItem* item = menu->FindItem(kFindButton);
	UpdateFindItem(item);
...
BMenuItem*
TShortcuts::UpdateGetInfoItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;

	BMenuItem* item = menu->FindItem(kGetInfo);
...
BMenuItem*
TShortcuts::UpdateIdentifyItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;

	BMenuItem* item = menu->FindItem(kIdentifyEntry);
...
BMenuItem*
TShortcuts::UpdateInvertSelectionItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;

	BMenuItem* item = menu->FindItem(kInvertSelection);
...
BMenuItem*
TShortcuts::UpdateMakeActivePrinterItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;

	BMenuItem* item = menu->FindItem(kMakeActivePrinter);
...
BMenuItem*
TShortcuts::UpdateMoveToItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;

	BMenuItem* item = menu->FindItem(kMoveSelectionTo);
...
BMenuItem*
TShortcuts::UpdateMoveToTrashItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;

	BMenuItem* item = FindItem(menu, kMoveSelectionToTrash, kDeleteSelection);
...
BMenuItem*
TShortcuts::UpdateNewFolderItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;

	BMenuItem* item = menu->FindItem(kNewFolder);
...
BMenuItem*
TShortcuts::UpdateNewTemplatesItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;

	BMenuItem* item = menu->FindItem(kNewEntryFromTemplate);
...
BMenuItem*
TShortcuts::UpdateOpenItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;

	BMenuItem* item = menu->FindItem(kOpenSelection);
	UpdateOpenItem(item);
...
BMenuItem*
TShortcuts::UpdateOpenParentItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;

	BMenuItem* item = menu->FindItem(kOpenParentDir);
...
BMenuItem*
TShortcuts::UpdateOpenWithItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;

	BMenuItem* item = menu->FindItem(kOpenSelectionWith);
	UpdateOpenWithItem(item);
...
BMenuItem*
TShortcuts::UpdatePasteItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;

	BMenuItem* item = FindItem(menu, B_PASTE, kPasteLinksFromClipboard);
...
BMenuItem*
TShortcuts::UpdateResizeToFitItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;

	BMenuItem* item = menu->FindItem(kResizeToFit);
...
BMenuItem*
TShortcuts::UpdateRestoreItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;

	BMenuItem* item = menu->FindItem(kRestoreSelectionFromTrash);
...
BMenuItem*
TShortcuts::UpdateSelectItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;

	BMenuItem* item = menu->FindItem(kShowSelectionWindow);
...
BMenuItem*
TShortcuts::UpdateSelectAllItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;

	BMenuItem* item = menu->FindItem(B_SELECT_ALL);
...
BMenuItem*
TShortcuts::UpdateUnmountItem(BMenu* menu)
{
	if (menu == NULL)
		return NULL;
