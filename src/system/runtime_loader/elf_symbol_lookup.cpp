...
static bool
match_symbol(image_t* image, const SymbolLookupInfo& lookupInfo, bool allowLocal, uint32 symnum,
	match_result& result)
{
	elf_sym* symbol = &image->syms[symnum];
	...
	uint32 versionID = image->symbol_versions[symnum];
