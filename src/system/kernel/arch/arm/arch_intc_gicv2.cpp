...
: InterruptController()
{
	area_id gicd_area = vm_map_physical_memory(B_SYSTEM_TEAM, "intc-gicv2-gicd", (void**)&gicd_regs,
	...
	area_id gicc_area = vm_map_physical_memory(B_SYSTEM_TEAM, "intc-gicv2-gicc", (void**)&gicc_regs,
