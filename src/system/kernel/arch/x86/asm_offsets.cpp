...
dummy()
{
	...
	DEFINE_OFFSET_MACRO(EXTENDED_SYSCALL_INFO, extended_syscall_info, parameter_count);
	DEFINE_OFFSET_MACRO(EXTENDED_SYSCALL_INFO, extended_syscall_info, parameters);

	// struct syscall_parameter_info
	DEFINE_SIZEOF_MACRO(SYSCALL_PARAMETER_INFO, syscall_parameter_info);
	DEFINE_OFFSET_MACRO(SYSCALL_PARAMETER_INFO, syscall_parameter_info, used_size);
