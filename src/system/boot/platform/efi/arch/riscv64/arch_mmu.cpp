...
static const uint32 kDefaultPageFlags = 0x7;
    // Valid, Read, Write
static const uint64 kTableMappingFlags = 0x18;
    // Valid, Read, Write, User
static const uint64 kPageMappingFlags = 0x38;
    // Valid, Read, Write, User, Global
