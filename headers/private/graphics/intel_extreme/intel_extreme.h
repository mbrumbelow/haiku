...
#define TGL_DPLL0_CFGCR					0x164288
#define TGL_DPLL1_CFGCR					0x164290
#define TGL_TBTPLL_CFGCR				0x1642A0
#define TGL_DPLL4_CFGCR					0x164298
#define TGL_DPLL_QDIV_RATIO				(0xFF << 10)
#define TGL_DPLL_QDIV_MODE				(1 << 9)
...
#define TGL_DPLLL_I_FB_PREDIVIDER		(0xF << 8)
#define TGL_DPLLL_I_FB_DIVIDER_M2		(0xFF << 0)
