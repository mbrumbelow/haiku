...
struct picture_player_callbacks {
	...
	void (*draw_bezier)(void* userData, const BPoint controlPoints[], bool fill);
	...
	void (*draw_bezier_gradient)(void* userData, const BPoint controlPoints[], BGradient& gradient, bool fill);
