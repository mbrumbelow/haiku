...
static ALWAYS_INLINE uint64 PhysAdrPte(uint64 physAdr, uint32 level)
{
	return (physAdr >> (pageBits + pteIdxBits*level)) % (1 << pteIdxBits);
}

static ALWAYS_INLINE uint64 PhysAdrOfs(uint64 physAdr)
{
	return physAdr % pageSize;
}

// CPU core ID
static ALWAYS_INLINE uint64 Mhartid() {
	uint64 x; asm volatile("csrr %0, mhartid" : "=r" (x)); return x;}

// status register
static ALWAYS_INLINE uint64 Mstatus() {
	uint64 x; asm volatile("csrr %0, mstatus" : "=r" (x)); return x;}
static ALWAYS_INLINE void SetMstatus(uint64 x) {
	asm volatile("csrw mstatus, %0" : : "r" (x));}
static ALWAYS_INLINE uint64 Sstatus() {
	uint64 x; asm volatile("csrr %0, sstatus" : "=r" (x)); return x;}
static ALWAYS_INLINE void SetSstatus(uint64 x) {
	asm volatile("csrw sstatus, %0" : : "r" (x));}

// exception program counter
static ALWAYS_INLINE uint64 Mepc() {
	uint64 x; asm volatile("csrr %0, mepc" : "=r" (x)); return x;}
static ALWAYS_INLINE void SetMepc(uint64 x) {
	asm volatile("csrw mepc, %0" : : "r" (x));}
static ALWAYS_INLINE uint64 Sepc() {
	uint64 x; asm volatile("csrr %0, sepc" : "=r" (x)); return x;}
static ALWAYS_INLINE void SetSepc(uint64 x) {
	asm volatile("csrw sepc, %0" : : "r" (x));}

// interrupt pending
static ALWAYS_INLINE uint64 Mip() {
	uint64 x; asm volatile("csrr %0, mip" : "=r" (x)); return x;}
static ALWAYS_INLINE void SetMip(uint64 x) {
	asm volatile("csrw mip, %0" : : "r" (x));}
static ALWAYS_INLINE uint64 Sip() {
	uint64 x; asm volatile("csrr %0, sip" : "=r" (x)); return x;}
static ALWAYS_INLINE void SetSip(uint64 x) {
	asm volatile("csrw sip, %0" : : "r" (x));}

// interrupt enable
static ALWAYS_INLINE uint64 Sie() {
	uint64 x; asm volatile("csrr %0, sie" : "=r" (x)); return x;}
static ALWAYS_INLINE void SetSie(uint64 x) {
	asm volatile("csrw sie, %0" : : "r" (x));}
static ALWAYS_INLINE uint64 Mie() {
	uint64 x; asm volatile("csrr %0, mie" : "=r" (x)); return x;}
static ALWAYS_INLINE void SetMie(uint64 x) {
	asm volatile("csrw mie, %0" : : "r" (x));}

// exception delegation
static ALWAYS_INLINE uint64 Medeleg() {
	uint64 x; asm volatile("csrr %0, medeleg" : "=r" (x)); return x;}
static ALWAYS_INLINE void SetMedeleg(uint64 x) {
	asm volatile("csrw medeleg, %0" : : "r" (x));}
// interrupt delegation
static ALWAYS_INLINE uint64 Mideleg() {
	uint64 x; asm volatile("csrr %0, mideleg" : "=r" (x)); return x;}
static ALWAYS_INLINE void SetMideleg(uint64 x) {
	asm volatile("csrw mideleg, %0" : : "r" (x));}

// trap vector, 2 low bits: mode
static ALWAYS_INLINE uint64 Mtvec() {
	uint64 x; asm volatile("csrr %0, mtvec" : "=r" (x)); return x;}
static ALWAYS_INLINE void SetMtvec(uint64 x) {
	asm volatile("csrw mtvec, %0" : : "r" (x));}
static ALWAYS_INLINE uint64 Stvec() {
	uint64 x; asm volatile("csrr %0, stvec" : "=r" (x)); return x;}
static ALWAYS_INLINE void SetStvec(uint64 x) {
	asm volatile("csrw stvec, %0" : : "r" (x));}

// address translation and protection (pointer to page table and flags)
static ALWAYS_INLINE uint64 Satp() {
	uint64 x; asm volatile("csrr %0, satp" : "=r" (x)); return x;}
static ALWAYS_INLINE void SetSatp(uint64 x) {
	asm volatile("csrw satp, %0" : : "r" (x));}

// scratch register
static ALWAYS_INLINE uint64 Mscratch() {
	uint64 x; asm volatile("csrr %0, mscratch" : "=r" (x)); return x;}
static ALWAYS_INLINE void SetMscratch(uint64 x) {
	asm volatile("csrw mscratch, %0" : : "r" (x));}
static ALWAYS_INLINE uint64 Sscratch() {
	uint64 x; asm volatile("csrr %0, sscratch" : "=r" (x)); return x;}
static ALWAYS_INLINE void SetSscratch(uint64 x) {
	asm volatile("csrw sscratch, %0" : : "r" (x));}

// trap cause
static ALWAYS_INLINE uint64 Mcause() {
	uint64 x; asm volatile("csrr %0, mcause" : "=r" (x)); return x;}
static ALWAYS_INLINE void SetMcause(uint64 x) {
	asm volatile("csrw mcause, %0" : : "r" (x));}
static ALWAYS_INLINE uint64 Scause() {
	uint64 x; asm volatile("csrr %0, scause" : "=r" (x)); return x;}
static ALWAYS_INLINE void SetScause(uint64 x) {
	asm volatile("csrw scause, %0" : : "r" (x));}

// trap value
static ALWAYS_INLINE uint64 Mtval() {
	uint64 x; asm volatile("csrr %0, mtval" : "=r" (x)); return x;}
static ALWAYS_INLINE void SetMtval(uint64 x) {
	asm volatile("csrw mtval, %0" : : "r" (x));}
static ALWAYS_INLINE uint64 Stval() {
	uint64 x; asm volatile("csrr %0, stval" : "=r" (x)); return x;}
static ALWAYS_INLINE void SetStval(uint64 x) {
	asm volatile("csrw stval, %0" : : "r" (x));}

// machine-mode counter enable
static ALWAYS_INLINE uint64 Mcounteren() {
	uint64 x; asm volatile("csrr %0, mcounteren" : "=r" (x)); return x;}
static ALWAYS_INLINE void SetMcounteren(uint64 x) {
	asm volatile("csrw mcounteren, %0" : : "r" (x));}

// machine-mode cycle counter
static ALWAYS_INLINE uint64 Mcycle() {
	uint64 x; asm volatile("csrr %0, mcycle" : "=r" (x)); return x;}
// monotonic timer
static ALWAYS_INLINE uint64 CpuTime() {
	uint64 x; asm volatile("csrr %0, time" : "=r" (x)); return x;}

// flush the TLB
static ALWAYS_INLINE void FlushTlbAll() {
	asm volatile("sfence.vma" : : : "memory");}
static ALWAYS_INLINE void FlushTlbPage(uint64 x) {
	asm volatile("sfence.vma %0" : : "r" (x) : "memory");}

static ALWAYS_INLINE uint64 Sp() {
	uint64 x; asm volatile("mv %0, sp" : "=r" (x)); return x;}
static ALWAYS_INLINE void SetSp(uint64 x) {
	asm volatile("mv sp, %0" : : "r" (x));}
static ALWAYS_INLINE uint64 Fp() {
	uint64 x; asm volatile("mv %0, fp" : "=r" (x)); return x;}
static ALWAYS_INLINE void SetFp(uint64 x) {
	asm volatile("mv fp, %0" : : "r" (x));}
static ALWAYS_INLINE uint64 Tp() {
	uint64 x; asm volatile("mv %0, tp" : "=r" (x)); return x;}
static ALWAYS_INLINE void SetTp(uint64 x) {
	asm volatile("mv tp, %0" : : "r" (x));}
static ALWAYS_INLINE uint64 Ra() {
	uint64 x; asm volatile("mv %0, ra" : "=r" (x)); return x;}
static ALWAYS_INLINE void SetRa(uint64 x) {
...
static ALWAYS_INLINE void Mret() {asm volatile("mret");}
static ALWAYS_INLINE void Sret() {asm volatile("sret");}
