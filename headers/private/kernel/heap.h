...
void* memalign_etc(size_t alignment, size_t size, uint32 flags) __attribute__ ((alloc_align (1)));
void free_etc(void* address, uint32 flags);

void* memalign(size_t alignment, size_t size) __attribute__ ((alloc_align (1)));
...
void* heap_memalign(heap_allocator* heap, size_t alignment, size_t size) __attribute__ ((alloc_align (2)));
