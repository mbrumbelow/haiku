...
#define	IA32_HWP_REQUEST_MINIMUM_PERFORMANCE			(0xffUL << 0)
#define	IA32_HWP_REQUEST_MAXIMUM_PERFORMANCE			(0xffUL << 8)
#define	IA32_HWP_REQUEST_DESIRED_PERFORMANCE			(0xffUL << 16)
#define	IA32_HWP_REQUEST_ENERGY_PERFORMANCE_PREFERENCE	(0xffUL << 24)
#define	IA32_HWP_REQUEST_ACTIVITY_WINDOW				(0x3ffUL << 32)
#define	IA32_HWP_REQUEST_PACKAGE_CONTROL				(1UL << 42)
#define	IA32_HWP_REQUEST_ACTIVITY_WINDOW_VALID			(1UL << 59)
#define	IA32_HWP_REQUEST_EPP_VALID 						(1UL << 60)
#define	IA32_HWP_REQUEST_DESIRED_VALID					(1UL << 61)
#define	IA32_HWP_REQUEST_MAXIMUM_VALID					(1UL << 62)
#define	IA32_HWP_REQUEST_MINIMUM_VALID					(1UL << 63)
