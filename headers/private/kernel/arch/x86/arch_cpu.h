...
#define	IA32_HWP_REQUEST_MINIMUM_PERFORMANCE			(0xff << 0)
#define	IA32_HWP_REQUEST_MAXIMUM_PERFORMANCE			(0xff << 8)
#define	IA32_HWP_REQUEST_DESIRED_PERFORMANCE			(0xff << 16)
#define	IA32_HWP_REQUEST_ENERGY_PERFORMANCE_PREFERENCE	(0xff << 24)
#define	IA32_HWP_REQUEST_ACTIVITY_WINDOW				(0x3ff << 32)
