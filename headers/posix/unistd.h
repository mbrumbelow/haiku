 ...
 * function, it is still available in libbe, but it is normally not made visible by this header
...
// need to check the actual C standard as well in case someone tries to build with -stc=c89 as well?
#ifdef __clang__
