...
uint8_t interrupt_pin;
 ...
 uint32_t rom_size;
 uint8_t base_register_flags[6];
 uint8_t min_grant;
 uint8_t max_latency;
 uint32_t base_registers[6];
 uint32_t base_registers_pci[6];
 uint32_t base_register_sizes[6];
 };

 struct {
 uint32_t base_registers[2];
 uint32_t base_registers_pci[2];
 uint32_t base_register_sizes[2];
 uint8_t primary_bus;
...
uint32memory_base;
uint32memory_limit;
uint32memory_base_upper32;
uint32memory_limit_upper32;
uint32io_base;
uint32io_limit;
uint32io_base_upper32;
uint32io_limit_upper32;
uint16secondary_status;
uint16bridge_control;
