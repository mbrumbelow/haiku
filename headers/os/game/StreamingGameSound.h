...
{
public:
        BStreamingGameSound(size_t bufferFrameCount, const gs_audio_format* format,
                size_t bufferCount = 2, BGameSoundDevice* device = NULL);
        ...
        virtual status_t SetAttributes(
                gs_attribute* attributes, size_t attributeCount);
...
private:
        void (*fStreamHook)(
                void* cookie, void* buffer, size_t bytes, BStreamingGameSound* sound);
        void* fStreamCookie;
        BLocker fLock;
