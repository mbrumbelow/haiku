...
public:
								...
								BMenuItem(const char* label, BMessage* message, char shortcut,
									uint32 rawKey, uint32 modifiers);
	...
	/*virtual*/	void			SetShortcut(uint32 rawKey, char shortcut, uint32 modifiers);
