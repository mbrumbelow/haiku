...
enum {
	...
	B_SCROLL_KEY						= 0x0f,
	B_PAUSE_KEY							= 0x10,
	B_MEDIA_PAUSE_KEY					= 0x80,
	B_MEDIA_PLAY_KEY					= 0x81,
	B_MEDIA_PLAY_PAUSE_KEY				= 0x82,
	B_MEDIA_SELECT_KEY					= 0x83,
	B_MEDIA_NEXT_TRACK_KEY				= 0x84,
	B_MEDIA_PREVIOUS_TRACK_KEY			= 0x85,
	B_MEDIA_STOP_KEY					= 0x86,
	B_APP_CALCULATOR_KEY				= 0x87,
	B_APP_TRACKER_KEY					= 0x88,
	B_APP_EMAIL_KEY						= 0x89,
	B_WWW_HOME_KEY						= 0x8A,
	B_WWW_FORWARD_KEY					= 0x8B,
	B_WWW_BACK_KEY						= 0x8C,
	B_WWW_SEARCH_KEY					= 0x8D,
	B_WWW_BOOKMARKS_KEY					= 0x8E,
	B_WWW_REFRESH_KEY					= 0x8F,
	B_WWW_STOP_KEY						= 0x90,
	B_VOLUME_UP_KEY						= 0x91,
	B_VOLUME_DOWN_KEY					= 0x92,
	B_VOLUME_MUTE_KEY					= 0x93
	B_SYSTEM_SHUTDOWN_KEY				= 0x94,
	B_SYSTEM_SLEEP_KEY					= 0x95,
	B_SYSTEM_WAKE_KEY					= 0x96,
	B_SYSTEM_BACKLIGHT_UP_KEY			= 0x97,
	B_SYSTEM_BACKLIGHT_DOWN_KEY			= 0x98,
	B_SYSTEM_BACKLIGHT_TOGGLE_KEY		= 0x99,
	B_APP_MESSENGER_KEY					= 0x9A,
	B_APP_WEBCAM_KEY					= 0x9B,
	B_SYSTEM_WIFI_TOGGLE_KEY			= 0x9C,
	B_SYSTEM_TOUCHPAD_TOGGLE_KEY		= 0x9D,
	B_APP_TEAM_MONITOR_KEY				= 0x9E
	B_SYSTEM_SECOND_SCREEN_TOGGLE_KEY	= 0x9F,
	B_SYSTEM_AIRPLANE_MODE_TOGGLE_KEY	= 0xA0,
	B_SYSTEM_LOCK_SCREEN_KEY			= 0xA1,
	B_SYSTEM_KEYBOARD_BACKLIGHT_UP_KEY	= 0xA2,
	B_SYSTEM_KEYBOARD_BACKLIGHT_DOWN_KEY	= 0xA3,
	B_SYSTEM_KEYBOARD_BACKLIGHT_TOGGLE_KEY	= 0xA4,
};
