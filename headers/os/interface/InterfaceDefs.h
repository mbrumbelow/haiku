...
status_t		get_multiple_mouse_type(const char* mouse_name, int32* type);
status_t		set_multiple_mouse_type(const char* mouse_name, int32 type);
...
status_t		get_multiple_mouse_speed(const char* mouse_name, int32* speed);
status_t		set_multiple_mouse_speed(const char* mouse_name, int32 speed);
