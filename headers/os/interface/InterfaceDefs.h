...
status_t		get_mouse_type(BString mouse_name, int32* type);
status_t		set_mouse_type(BString mouse_name, int32 type);
...
status_t		get_mouse_speed(BString mouse_name, int32* speed);
status_t		set_mouse_speed(BString mouse_name, int32 speed);
status_t		get_mouse_acceleration(int32* speed); // deprecated
status_t		get_mouse_acceleration(BString mouse_name, int32* speed);
status_t		set_mouse_acceleration(BString mouse_name, int32 speed);
